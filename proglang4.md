...
Правда же, это просто? И из вот этой простой идеи в результате выросла одна из самых сложных
и мощных концепций программирования. Давайте посмотрим, что еще можно сделать с этой идеей.
...
известен во время ко��пиляции, декларируется, что "*ссылки на типы объектов совместимы по
