...
Проблема состоит в том, что, хотя в языке L-типа всегда можно сделать проверки на безопасность, многие программисты полагают,
...
значения, за редкими исключениями, а для ссылок наоборот — подавляющее большинство адресов вызовет ошибку при
...
всяких сложностей называть *разные* области памяти. Ссылки дают возможность *разными* именами обозначить
